...
for i in energy_i:
    with open("input1/input_"+str(int(i))+"keV.mcn", "w") as file:
        for j in range(1,44):
...
with open("script.bat", "w") as file2:
    for i in energy_i:
        file2.write("mcnp6 i=input1/input_"+str(int(i))+"keV.mcn r=run/run_"+str(int(i))+"keV.r o=output1/output_"+str(int(i))+"keV.o\n")