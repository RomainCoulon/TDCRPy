...
The stopping power of electrons between 20 keV and 1000 keV is a mixture of a radiative loss model ESTAR [[7]](#7) and a collision model ESTAR [[8]](#8) that has been validated agaisnt the NIST model ESTAR [[9]](#9) recommanded by the ICRU Report 37 [[10]](#10). At low energy - between 10 eV and 20 keV - the model from Tan and Xia [[11]](#11) is implemented.
